...
#
# This script updates:
#   - chip-for-gravity-forms.php  (Version header + GF_CHIP_MODULE_VERSION)
...
CURRENT_VERSION=$(grep "Version:" chip-for-gravity-forms.php | head -1 | awk '{print $3}')
...
# chip-for-gravity-forms.php — Version header
sed -i.bak "s/^ \* Version: ${CURRENT_VERSION}/ * Version: ${NEW_VERSION}/" chip-for-gravity-forms.php
rm -f chip-for-gravity-forms.php.bak

# chip-for-gravity-forms.php — GF_CHIP_MODULE_VERSION constant
sed -i.bak "s/GF_CHIP_MODULE_VERSION', 'v${CURRENT_VERSION}'/GF_CHIP_MODULE_VERSION', 'v${NEW_VERSION}'/" chip-for-gravity-forms.php
rm -f chip-for-gravity-forms.php.bak
...
if ! $YES; then
    ...
    echo "  3. git tag gravity-forms-upload-v${NEW_VERSION}"
