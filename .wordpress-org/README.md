...
This directory contains images displayed on the [WordPress.org plugin page](https://wordpress.org/plugins/chip-for-gravity-forms/).
...
These files are synced to `https://plugins.svn.wordpress.org/chip-for-gravity-forms/assets/`
