...
class GF_Chip extends GFPaymentAddOn {
	...
	public function entry_info( $form_id, $entry ) {
		...
		<br>
		<input id="refundpay" type="button" name="refundpay" value="<?php esc_html_e( 'Refund', 'gravityformschip' ) ?>"
		...
		<img src="<?php echo GFCommon::get_base_url() ?>/images/spinner.svg" id="refund_spinner" style="display: none;" />
